...
RA_Strings = {
	["en"] = {
		SETTINGS = {
			...
			BLACKSMITH_LABEL = "Track Blacksmithing?",
			BLACKSMITH_TOOLTIP = "Toggle the Research Assistant for Blacksmithing.",

			CLOTHIER_LABEL = "Track Clothier?",
			CLOTHIER_TOOLTIP = "Toggle the Research Assistant for Clothier.",

			WOODWORKING_LABEL = "Track Woodworking?",
			WOODWORKING_TOOLTIP = "Toggle the Research Assistant for Woodworking.",
	...
	["de"] = {
		SETTINGS = {
			...
			ICON_TOOLTIP = "Wähle welche art von Icons an zu analysierenden Items gezeigt werden soll.",

			RESEARCHABLE_LABEL = "Farbe für analysierbare Gegenstände",
			RESEARCHABLE_TOOLTIP = "Welche Farbe sollen die Icons haben wenn der Gegenstand analysierbar ist?",

			DUPLICATE_LABEL = "Farbe für doppelte Gegenstände",
			DUPLICATE_TOOLTIP = "Welche Farbe soll das Icon haben wenn der Gegenstand analysierbar ist, aber ein besserer Kandidat für das Analysieren vorhanden ist?",

			RESEARCHED_LABEL = "Farbe für analysierte Gegenstände",
			RESEARCHED_TOOLTIP = "Welche Farbe sollen die Icons haben wenn der die Eigenschaft des Gegenstands bereits analysiert wurde?",

			ORNATE_LABEL = "Farbe für hohen Verkaufspreis",
			ORNATE_TOOLTIP = "Welche Farbe sollen die Icons haben wenn der Gegenstand einen hohen Verkaufspreis hat?",

			INTRICATE_LABEL = "Farbe für Gegenstände mit Inspiration",
			INTRICATE_TOOLTIP = "Welche Farbe sollen die Icons haben wenn der Gegenstand beim verwerten extra Erfahrung gewährt?",

			BLACKSMITH_LABEL = "Schmiedekunst anzeigen?",
			BLACKSMITH_TOOLTIP = "Umschalten ob die Icons bei Schmiedbaren Gegensänden angezeigt werden.",

			CLOTHIER_LABEL = "Schneiderei anzeigen?",
			CLOTHIER_TOOLTIP = "Umschalten ob die Icons bei Schneiderbaren Gegensänden angezeigt werden.",

			WOODWORKING_LABEL = "Schreinerei anzeigen?",
			WOODWORKING_TOOLTIP = "Umschalten ob die Icons bei Schreinerbaren Gegensänden angezeigt werden.",
			...
			SHOW_INTRICATE_LABEL = "Inspiration immer zeigen?",
